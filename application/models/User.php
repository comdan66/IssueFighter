...
class User extends OaModel {
  ...
  static $has_many = array (
    ...
    array ('issues', 'class_name' => 'Issue'),
    array ('comments', 'class_name' => 'Comment'),
    array ('comment_likes', 'class_name' => 'CommentLike', 'conditions' => array ('status != ?', CommentLike::STATUS_1)),
  );
  ...
  public function score () {
    return count ($this->comment_likes) * 1.5 + count ($this->comments) * 1 + count ($this->issues) * 0.5 + $this->cnt_login * 0.7;
  }
}